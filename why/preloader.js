...
function initImages() {
    ...
    if (!mobile) {
        ...
        img_mainMenu_IE = new Image();
        img_mainMenu_capitalism = new Image();
        img_mainMenu_ronald = new Image()
        ...
        img_mainMenu_IE.src    = "images/IE10.png";
        img_mainMenu_capitalism.src    = "images/capitalism.png";
        img_mainMenu_ronald.src    = "images/Remove_background_4.png";
...
function drawPreloader() {
	...
	canvas.font = cwh(16) + "px Arial";
	canvas.textAlign = "center";
	canvas.fillText("This is the Source Of All Suffering.", cwh(CANVAS_WIDTH / 2) + os.x, cwh(310) + os.y);
	canvas.fillText("There is a good reason why God stays in Heaven.", cwh(CANVAS_WIDTH / 2) + os.x, cwh(330) + os.y);
	canvas.fillText("This is that reason.", cwh(CANVAS_WIDTH / 2) + os.x, cwh(350) + os.y);
}