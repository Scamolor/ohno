var enemies = [
	...
	[
        ...
        new simpleEnemy(260, 260, 171, 429, 0, 5),
		new simpleEnemy(380, 380, 429, 171, 0, 5),
		new simpleEnemy(420, 420, 429, 171, 0, 5),
		new simpleEnemy(460, 460, 429, 171, 0, 5),
		new simpleEnemy(500, 500, 429, 171, 0, 5),
		new simpleEnemy(540, 540, 171, 429, 0, 5),
		new simpleEnemy(580, 580, 429, 171, 0, 5),
        new simpleEnemy(560, 560, 171, 429, 0, 5),
		new simpleEnemy(600, 600, 429, 171, 0, 5),
        new simpleEnemy(640, 640, 171, 429, 0, 5),
        new simpleEnemy(680, 680, 429, 171, 0, 5),
        new simpleEnemy(630, 630, 171, 429, 0, 5),
  		new simpleEnemy(640, 640, 429, 171, 0, 5),
        new simpleEnemy(650, 650, 171, 429, 0, 5),
	],
	...
	[
		...
		new simpleCircularEnemy(400, 300, 40, 90, -2),
       	new simpleCircularEnemy(400, 300, 40, 180, -2),
		new simpleCircularEnemy(400, 300, 40, 0, -2),
		new simpleCircularEnemy(400, 300, 120, 270, 2),
		new simpleCircularEnemy(400, 300, 120, 90, 2),
        new simpleCircularEnemy(400, 300, 120, 180, -2),
		new simpleCircularEnemy(400, 300, 120, 0, -2),
...
function drawEnemies() {
	if (state == "game") {
		...
		for (var i = 0; i < enemies[level].length; i++) {
			...
			canvas.stroke();
            if (level != 15) {
                canvas.drawImage(img_mainMenu_IE, enemies[level][i].x - 32, enemies[level][i].y - 32);
        	} else {
                canvas.drawImage(img_mainMenu_capitalism, enemies[level][i].x - 128, enemies[level][i].y - 128);
	        } 
		}
	}
}
